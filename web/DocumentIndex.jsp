                        ...
                        <div class="col-md-12">
                            <div class="content-panel">
                                <table class="table table-striped table-advance table-hover">
                                    ...
                                    <!-- table中标题 -->
                                    <tr>
                                        <th><i class="fa fa-bullhorn"></i> 文件id</th>
                                        <th class="hidden-phone"><i class="fa fa-question-circle"></i> 文件名</th>
                                        <th><i class="fa fa-bookmark"></i> 文件描述</th>
                                    ...
                                    <c:forEach var="Item" items="${DocumentList}">
                                        <tr>
                                            ...
                                            <td class="hidden-phone">${Item.filename}</td>
                                            <td><span class="label label-info label-mini">${Item.remark}</span>
                                            </td>
