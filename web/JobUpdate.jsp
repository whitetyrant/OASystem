...
<div id="login-page">
    <div class="container">
        ...
        <form method="post" action="/oa/UpdateJob">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>职员名：</p>
                        <input type="text" name="name" placeholder="请输入职员" value="${Job.name}"
                    ...
                    <div class="modal-body">
                        ...
                        <textarea type="text" name="remark"
                                  autocomplete="off" class="form-control placeholder-no-fix">${Job.remark}</textarea>
